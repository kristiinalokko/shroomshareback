...
ALTER TABLE comment_image ADD CONSTRAINT comment_image_comment
...
ALTER TABLE comment ADD CONSTRAINT comment_location
...
ALTER TABLE favorites ADD CONSTRAINT favorites_location
    FOREIGN KEY (location_id)
    REFERENCES location (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shroom_image ADD CONSTRAINT shroom_image_shroom
...
ALTER TABLE shroom_location ADD CONSTRAINT shroom_location_location
    FOREIGN KEY (location_id)
    REFERENCES location (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shroom_location ADD CONSTRAINT shroom_location_shroom
    FOREIGN KEY (shroom_id)
    REFERENCES shroom (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shroom ADD CONSTRAINT shroom_user
    FOREIGN KEY (user_id)
    REFERENCES "user" (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
